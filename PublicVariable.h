...
const KV SHOW_FLOATING_PREVIEW{"SHOW_FLOATING_PREVIEW", true, ValueChecker{ValueChecker::VALUE_TYPE::PLAIN_BOOL}};
...
const QStringList VIDEO_TYPE_SET = {"*.mp4", "*.m4v", "*.mov", "*.avi", "*.flv", "*.wmv", "*.mkv", "*.divx", "*.m4v", "*.mpg", "*.ts", "*.vob", "*.iso"};
