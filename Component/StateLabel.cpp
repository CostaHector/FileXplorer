...
public:
    QPushButton* save;
    QPushButton* change;
    explicit StateLabelWidget(QWidget* parent=nullptr): QWidget(parent),
        ...
        connect(save, &QPushButton::clicked, this, [textEdit]()->void{
            textEdit->ToSaved();
        });
        connect(change, &QPushButton::clicked, this, [textEdit]()->void{
            textEdit->ToNotSaved();
        });
