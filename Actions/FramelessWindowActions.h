...
public:
    ...
    auto Get_FRAMELESS_MENU_Actions() -> QActionGroup*{
        ...
        _EXPAND_RIBBONS->setToolTip(QString("<b>%1 (%2)</b><br/> Show tabs with visible commands when enabled, or show tabs with hidden commands").arg
                                    (_EXPAND_RIBBONS->text(), _EXPAND_RIBBONS->shortcut().toString()));
        ...
        _FRAMELESS->setToolTip(QString("<b>%1 (%2)</b><br/> Set window framless or not.").arg
                               (_FRAMELESS->text(), _FRAMELESS->shortcut().toString()));
        ...
        _MINIMIZE->setToolTip(QString("<b>%1 (%2)</b><br/> Shows the widget minimized, as an icon.").arg
                              (_MINIMIZE->text(), _MINIMIZE->shortcut().toString()));
        ...
        _MAXIMIZE->setToolTip(QString("<b>%1 (%2)</b><br/> Shows the widget maximized or Restores the widget after it has been maximized or minimized.").arg
                              (_MAXIMIZE->text(), _MAXIMIZE->shortcut().toString()));
