...
PerformersManagerActions::PerformersManagerActions(QObject* parent)
    : QObject{parent},
      ...
      INIT_TABLE(new QAction(QString("Create table [%1]").arg(PERFORMERS_TABLE_NAME), this)),
      INSERT_INTO_TABLE(new QAction(QString("insert into table [%1]").arg(PERFORMERS_TABLE_NAME), this)),
