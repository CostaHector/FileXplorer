...
FileBasicOperationsActions::FileBasicOperationsActions(QObject *parent): QObject(parent) ,
...
public:
    explicit FileOperationActionIllustration(const QString &title, QWidget *parent = nullptr):
