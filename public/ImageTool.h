...
struct IMAGE_SIZE {
  ...
  static constexpr QSize ICON_SIZE_CANDIDATES[] //
      {
          QSize(25, 16),   QSize(40, 25),   QSize(65, 40),   QSize(105, 65),  QSize(170, 105),  QSize(275, 170),   QSize(323, 200),   QSize(445, 275),   QSize(485, 300),   QSize(566, 350),
          QSize(648, 400), QSize(720, 445), QSize(809, 500), QSize(970, 600), QSize(1165, 720), QSize(1885, 1165), QSize(3050, 1885), QSize(4935, 3050), QSize(7985, 4935), QSize(12920, 7985),
      };
