...
const KV MemoryKey::FOLDER_PREVIEW_TYPE{"FOLDER_PREVIEW_TYPE", 0, ValueChecker{PLAIN_INT}};
...
const KV MemoryKey::EXPAND_QUICK_NAVIGATION_TOOL_BAR("EXPAND_QUICK_NAVIGATION_TOOL_BAR", false, ValueChecker{PLAIN_BOOL});
...
const KV MemoryKey::VIDEO_PLAYER_PLAYBACK_MODE{"VIDEO_PLAYER_PLAYBACK_MODE", 0, ValueChecker{0, 10 + 1}};
const KV MemoryKey::VIDEO_PLAYER_PLAYBACK_TRIGGER_MODE{"VIDEO_PLAYER_PLAYBACK_TRIGGER_MODE", 0, ValueChecker{0, 10 + 1}};
const KV MemoryKey::VIDEO_PLAYER_AUTO_HIDE_TOOLBAR{"VIDEO_PLAYER_AUTO_HIDE_TOOLBAR", false, ValueChecker{PLAIN_BOOL}};
...
const KV MemoryKey::GRAY_ENTRIES_DONT_PASS_FILTER{"GRAY_ENTRIES_DONT_PASS_FILTER", false, ValueChecker{PLAIN_BOOL}};
const KV MemoryKey::ADVANCE_SEARCH_MODE{"ADVANCE_SEARCH_MODE", 0, ValueChecker{PLAIN_INT}};
...
const KV MemoryKey::RENAMER_NUMERIAZER_UNIQUE_EXT_COUNTER{"RENAMER_NUMERIAZER_UNIQUE_EXT_COUNTER", true, ValueChecker{PLAIN_BOOL}};
...
const KV MemoryKey::ALL_LOG_LEVEL_AUTO_FFLUSH{"ALL_LOG_LEVEL_AUTO_FFLUSH", QtMsgType::QtWarningMsg, ValueChecker{PLAIN_INT}};
