...
const KV MemoryKey::VIDEO_PLAYER_PLAY_SELECT_INSTANTLY{"VIDEO_PLAYER_PLAY_SELECT_INSTANTLY", false, ValueChecker{PLAIN_BOOL}};
...
const KV MemoryKey::GRAY_ENTRIES_DONT_PASS_FILTER{"GRAY_ENTRIES_DONT_PASS_FILTER", true, ValueChecker{PLAIN_BOOL}};
