...
class UndoRedoTest : public FileSystemTestSuite {
 ...
 private slots:
  ...
  void test_RemovePermanently() {
    ...
    BATCH_COMMAND_LIST_TYPE rmfileCommand{ACMD{RMFILE, {mTestPath, "012.txt"}}};
  ...
  void test_moveToTrash() {
    ...
    BATCH_COMMAND_LIST_TYPE moveToTrashCommand{ACMD{MOVETOTRASH, {mTestPath, "012.txt"}}};
  ...
  void test_Rename() {
    ...
    BATCH_COMMAND_LIST_TYPE renameCommands1{ACMD{RENAME, {mTestPath, "012.txt", mTestPath, "210.txt"}}};
    ...
    BATCH_COMMAND_LIST_TYPE renameCommands2{ACMD{RENAME, {mTestPath, "210.txt", mTestPath, "999.txt"}}};
