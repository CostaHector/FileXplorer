...
bool GetSceneInfoList(int count, SceneSortOrderHelper::SortDimE sortDim, bool isReverse, SCENE_INFO_LIST& ansList) {
  ansList.clear();
  ansList.reserve(count);

  std::uniform_int_distribution<int> uniformIntDist(0, count + 1);
  std::default_random_engine e;
  SCENE_INFO siBasic{"/", "Ben Affleck", {}, {"Ben Affleck.mp4"}, 100 * 1024 * 1024, 10, "2000-06-16 00:00:60"};
...
class ScenesListModelTest : public PlainTestSuite {
 ...
 private slots:
  ...
  void sort_only_one_dimension_sorted() {
    ...
    {  // MOVIE_PATH
      SCENE_INFO_LIST mockMoviePathAscendingList;
    ...
    // 测试MOVIE_SIZE排序
    {
      SCENE_INFO_LIST mockMovieSizeDescendingList;  // 降序
    ...
    // 测试RATE排序
    {
      SCENE_INFO_LIST mockRateAscendingList;  // 升
    ...
    // 测试UPLOADED_TIME排序
    {
      SCENE_INFO_LIST mockUploadedDescendingList;  // 降
  ...
  void sort_no_directory_system_ok() {
    ...
    SCENE_INFO si0{"/", "Ben Affleck", {}, {"Ben Affleck.mp4"}, 100 * 1024 * 1024, 10, "2000-06-16 00:00:60"};
    SCENE_INFO si1{"/", "Brad Pitt", {}, {"Brad Pitt.mp4"}, 99 * 1024 * 1024, 11, "2000-06-16 00:00:59"};
    SCENE_INFO si2{"/", "Chris Evans", {}, {"Chris Evans.mp4"}, 98 * 1024 * 1024, 12, "2000-06-16 00:00:58"};
    SCENE_INFO si3{"/", "Chris Hemsworth", {}, {"Chris Hemsworth.mp4"}, 97 * 1024 * 1024, 13, "2000-06-16 00:00:57"};
    SCENE_INFO si4{"/", "Chris Pine", {}, {"Chris Pine.mp4"}, 96 * 1024 * 1024, 14, "2000-06-16 00:00:56"};
    SCENE_INFO si5{"/", "Chris Pratt", {}, {"Chris Pratt.mp4"}, 95 * 1024 * 1024, 15, "2000-06-16 00:00:55"};
    SCENE_INFO si6{"/", "Henry Cavill", {}, {"Henry Cavill.mp4"}, 94 * 1024 * 1024, 16, "2000-06-16 00:00:54"};
    SCENE_INFO si7{"/", "Keanu Reeves", {}, {"Keanu Reeves.mp4"}, 93 * 1024 * 1024, 17, "2000-06-16 00:00:53"};
    SCENE_INFO si8{"/", "Michael Fassbender", {}, {"Michael Fassbender.mp4"}, 92 * 1024 * 1024, 18, "2000-06-16 00:00:52"};
    SCENE_INFO si9{"/", "Tom Cruise", {}, {"Tom Cruise.mp4"}, 91 * 1024 * 1024, 19, "2000-06-16 00:00:51"};
    SCENE_INFO si10{"/Brazil/", "Kaka", {}, {"Kaka.mp4"}, 90 * 1024 * 1024, 20, "2000-06-16 00:00:50"};
    SCENE_INFO si11{"/French/", "Raphael Varane", {}, {"Raphael Varane.mp4"}, 89 * 1024 * 1024, 21, "2000-06-16 00:00:49"};
    SCENE_INFO si12{"/Polish/", "Robert Lewandowski", {}, {"Robert Lewandowski.mp4"}, 88 * 1024 * 1024, 22, "2000-06-16 00:00:48"};
    SCENE_INFO si13{"/Portuguese/", "Cristiano Ronaldo", {}, {"Cristiano Ronaldo.mp4"}, 87 * 1024 * 1024, 23, "2000-06-16 00:00:47"};
    SCENE_INFO si14{"/Spain/", "Alvaro Morata", {}, {"Alvaro Morata.mp4"}, 86 * 1024 * 1024, 24, "2000-06-16 00:00:46"};

    SCENE_INFO_LIST manualAppendToAInExistPath{
