...
// bool QCompressor::originCompress(const QByteArray& data, QByteArray &output, int level)
// {
//   auto compressedData = qCompress(data, level);
...
//   output = header + compressedData + footer;
//   return true;
// }
