...
FolderPreviewSwitcher::FolderPreviewSwitcher(CurrentRowPreviewer* folderPreview,
                                             QObject* parent)  //
    : QObject{parent},
      _folderPreview{folderPreview}  //
{}

bool FolderPreviewSwitcher::onSwitchByPreviewType(PreviewTypeTool::PREVIEW_TYPE_E viewType) {
