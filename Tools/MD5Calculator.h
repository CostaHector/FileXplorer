...
QString GetFileMD5(const QString& filepath, const int onlyFirstByte = -1);
QString GetByteArrayMD5(const QByteArray& ba);
QStringList GetBatchFileMD5(const QStringList& filepaths, const int onlyFirstByte = -1);
